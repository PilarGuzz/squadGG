// To parse this data:
//
//   import { Convert, PostDto } from "./file";
//
//   const postDto = Convert.toPostDto(json);
//
...
export class Convert {
    public static toPostDto(json: string): PostDto {
        return cast(JSON.parse(json), r("PostDto"));
    }

    public static postDtoToJson(value: PostDto): string {
        return JSON.stringify(uncast(value, r("PostDto")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Content": o([
        ...
        { json: "nickgame", js: "nickgame", typ: "" },
        { json: "levelingame", js: "levelingame", typ: "" },
        { json: "ranklevel", js: "ranklevel", typ: "" },
        { json: "username", js: "username", typ: "" },
        { json: "gamename", js: "gamename", typ: r("Gamename") },
        { json: "datepublication", js: "datepublication", typ: a(0) },
